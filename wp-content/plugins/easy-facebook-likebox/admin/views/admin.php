...
<?php $active_tab = isset( $_GET[ 'tab' ] ) ? $_GET[ 'tab' ] : 'general';?>
  ...
  <a href="<?php echo admin_url('admin.php')?>?page=mt-other-plugins&tab=myplugins" class="nav-tab <?php echo $active_tab == 'myplugins' ? 'nav-tab-active' : ''; ?>"><?php _e('My Plugins', 'easy-facebook-likebox'); ?></a>
